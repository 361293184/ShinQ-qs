...
规则：
- 每层一行 = 【类型】+ 第一人称内心一句话，每层 ≤48 字；想到几层写几层，六类都可以出现，不限制条数；
- 类型只能从这六个里选：真心话 / 吐槽 / 小动作 / 预谋 / 回忆 / 关系
  · 真心话：与台词相反的心里话（嘴硬、口是心非、故作镇定）。要写 30-48 字的完整内心独白 —— 写出你当时那一刻的具体感受、心理活动、为什么嘴硬 / 在意什么 / 明明在想什么却说不出口，把一个连续的心情段写完，而不是三五个字的短句；
  · 吐槽：对当下对话或对方状态的观察；
  · 小动作：一个没说出口的身体反应或小动作；
  · 预谋：没说出口的期待或计划；
