...
localStorage.setItem('vr_sar_club_state_v1',JSON.stringify({version:1,updateSeenVersion:1,npcPreference:new URLSearchParams(location.search).get('npcs')==='show'?'show':'hide',caianMet:false}));
