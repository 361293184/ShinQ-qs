...
export function SARFamiliarityKeepsake({ item, onClose }: { item:FamiliaritySouvenir; onClose:()=>void }) {
    ...
    return <div className="sar-keepsake" onKeyDown={event=>{
        ...
        <header><button type="button" autoFocus onClick={onClose} aria-label="收好纪念物"><ArrowLeft size={21}/></button><div><small>SAR · KEEPSAKES</small><h3>{item.title}</h3></div></header>
